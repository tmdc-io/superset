...
push-oci-chart:
	...
	aws ecr-public get-login-password --region ${AWS_DEFAULT_REGION} | helm3.14.0 registry login  --username AWS --password-stdin public.ecr.aws
	@echo
	@echo "=== package OCI chart ==="
	helm3.14.0 package ${CH_DIR}/${DIR}/ --version ${VERSION}
	@echo
	@echo "=== create repository ==="
	aws ecr-public describe-images --repository-name ${DIR} --region ${AWS_DEFAULT_REGION} || aws ecr-public create-repository --repository-name ${DIR} --region ${AWS_DEFAULT_REGION}
	@echo
	@echo "=== push OCI chart ==="
